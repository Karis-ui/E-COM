        ...
        try {
            ...
            setStats({
                revenue: {
                    ...
                    today: statsRes.data?.revenue?.today || 0,
                    this_month: statsRes.data?.revenue?.this_month || 0
                },
                orders: {
                    total: statsRes.data?.orders?.total || 0,
                    pending: statsRes.data?.orders?.pending || 0,
                    processing: statsRes.data?.orders?.processing || 0,
                    shipped: statsRes.data?.orders?.shipped || 0
                },
                customers: {
                    total: statsRes.data?.customers?.total || 0,
                    new_this_month: statsRes.data?.customers?.new_this_month || 0
                },
                products: {
                    total: statsRes.data?.products?.total || 0,
                    low_stock: statsRes.data?.products?.low_stock || 0,
                    out_of_stock: statsRes.data?.products?.out_of_stock || 0
                },
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
                    ...
                    <a href="/admin/orders" className="text-primary-600 hover:text-primary-700 text-sm flex items-center gap-1">
                        View all orders
                                ...
                                recentOrders.map((order, idx) => {
                                    ...
                                    return (
                                        <tr key={order.id} className="hover:bg-gray-50 transition">
                                            ...
                                            <td className="px-6 py-4">
                                                <a href={`/admin/orders/${order.id}`} className="text-primary-600 hover:text-primary-700">
